 ...
 * Date: 2024-08-23 17:08:11.474261
 */
...
VALUES(0, date_part('year', now()), date_part('month', now()), now(), 'update schema to support advanced visibility', '', '1.2', '0.1');